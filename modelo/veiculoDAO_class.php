...
class VeiculoDAO
{
	...
	//alugar
	public function alugar($idveiculo)
	{
		try {
			$stmt = $this->con->prepare(
				"UPDATE veiculo SET 
			...
			//ligamos as âncoras aos valores de veiculo
			$stmt->bindValue(":idveiculo", $idveiculo->getIdveiculo());
	...
	//desalocar
	public function desalocar($idveiculo)
	{
		try {
			$stmt = $this->con->prepare(
				"UPDATE veiculo SET 
	...
	//filtro caçamba
	public function listarCacamba($query = null)
	{
		//se não recebe parâmetro (ou seja, uma consulto personalizada)
		//$query recebe nulo
		try {
	...
	//filtro prancha
	public function listarPrancha($query = null)
	{
		//se não recebe parâmetro (ou seja, uma consulto personalizada)
		//$query recebe nulo
		try {
