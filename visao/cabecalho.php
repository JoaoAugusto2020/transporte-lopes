...
<body>
    ...
    <header>
        <nav>
            ...
            <div>
                <a href="visao/paginas/alugar.html" class="nav-link">Alugar Veículo</a>
            ...
            <div class="autenticar">
                <a href="visao/paginas/autenticar/registrar.html"><button type="button" class="registrar">Registrar</button></a>
                <a href="visao/paginas/autenticar/entrar.html"><button type="button" class="entrar">Entrar</button></a>
            </div>
        </nav>
    </header>
